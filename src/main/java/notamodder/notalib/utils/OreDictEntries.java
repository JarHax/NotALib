...
/**
 * Contains static fields for all of the standard ore dictionary entries.
 */
public class OreDictEntries {
    ...
    /**
     * Dumps the contents of the ore dictionary to the console. This isn't actually meant to be
     * used directly, just storing the code here so it can be used to re-generate the fields of
